...
const edit = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
    ...
    ...blockProperties
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, "Table of Contents Block"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Outputs a sticky anchor based scroll navigation."))));
};
...
const save = ({
  ...
  const listStyleElement = 'numbered' === listStyleType ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ol", {
    className: "toc-list numbered"
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "toc-list"
  });
  const unstyledClass = 'unstyled' === listStyleType ? 'unstyled-list' : '';
  blockProperties.className = _classes__WEBPACK_IMPORTED_MODULE_2__["default"].fromMany([(_blockProperties$clas = blockProperties.className) !== null && _blockProperties$clas !== void 0 ? _blockProperties$clas : '', unstyledClass]).toString();
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"kdc/table-of-contents-sticky-nav","version":"0.1.0","title":"Table Of Contents Sticky Nav","category":"widgets","icon":"format-aside","description":"A block that scrapes H2/H3 tags and appends them to a list to use as a sticky navigation.","keywords":["table of contents","nav","sidebar nav"],"attributes":{"listStyleType":{"type":"string","default":"unstyled"}},"textdomain":"table-of-contents-sticky-nav","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktable_of_contents_sticky_nav"] = globalThis["webpackChunktable_of_contents_sticky_nav"] || [];
